...
const Footer = () => {
  return (
    <footer className="bg-white pt-20 pb-10 px-6 border-t border-gray-100 text-brand-black">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
               <img src="/MYC LOGO BLALK.png" alt="MYC Logo" className="h-8 drop-shadow-sm" />
               <span className="font-bold text-lg text-brand-black">MYC <span className="text-brand-red italic">BEAUTY INNOVATION</span></span>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Leading the way in smart document processing and AI-driven translation solutions for businesses worldwide.
            </p>
          </div>

          <div>
            <h4 className="font-bold mb-6 text-brand-black">Platform</h4>
            <ul className="space-y-4 text-sm text-gray-500">
              <li><a href="#" className="hover:text-brand-red transition-colors">Home</a></li>
              <li><a href="#" className="hover:text-brand-red transition-colors">Process Document</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold mb-6 text-brand-black">Legal</h4>
            <ul className="space-y-4 text-sm text-gray-500">
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-brand-gray rounded-full border border-gray-200 hover:border-brand-red/50 hover:bg-red-50 transition-colors cursor-default order-1 md:order-3">
            <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">
              Developed by the <span className="text-brand-red">Technical Team</span> of MYC
            </span>
          </div>
        </div>
      </div>
